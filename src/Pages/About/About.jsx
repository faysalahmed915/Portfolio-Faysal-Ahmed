...
const About = () => {
  return (
    <section className="bg-base-200 text-base-content py-16 px-4 md:px-16" id="about">
      ...
      >
        <a href="#projects" className="btn btn-primary px-8 rounded-full mt-4">See My Projects</a>
      </motion.div>
    </section>
  );
};
